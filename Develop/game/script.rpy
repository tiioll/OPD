...
label start:
    ...
    $ Alex = renpy.input("Введите имя персонажа", length=12)
    ...
    u " - Можно написать оптимизированный код, сверстать красивый сайт и сделать кучу всего, если комп собран правильно! В противном случае, все это нереально!"
